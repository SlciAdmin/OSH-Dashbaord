...
const FORMS_DATA = [
  ...
  {n:"VIII",d:"Health Examination"},
  {n:"IX",d:"Report of Medical Examination"},
  {n:"X",d:"Certificate medical re-examination by Appellate Medical Board"},
  {n:"XI",d:"Notice of Accident / Dangerous Occurrence"},
  {n:"XII",d:"Notice of Periods of Work"},
  {n:"XIII",d:"Employee Register"},
  {n:"XIV",d:"Attendancew Register-Cum-Muster Roll"},
  {n:"XV",d:"Register For Wages, Overtime and Deductions"},
  {n:"XVI",d:"Wage slip"},
  {n:"XVII",d:"Annual Return"},
  {n:"XVIII",d:"Half Yearly Return (January to June / July to December) to be submitted electronically by the contractor to the Deputy Chief Labour Commissioner (Central)"},
  {n:"XIX",d:"Register of Accidents and  Dangerous Occurrences"},
  {n:"XX",d:"Register for Leave with wages"},
  {n:"XXI",d:"Application for Grant of Licence/ Renewal of Licence/Amendment of Licence (including common/single licence)"},
  {n:"XXII",d:"Proforma of Licence"},
  {n:"XXIII",d:"Experience certificate  of Contract Labour"},
  {n:"XXIV",d:"Agreement between Producer and Audio-visual worker"},
  {n:"XXV",d:"Improvement Notice"},
  {n:"XXVI",d:"Application for Composition of offence "},
  {n:"XXVII",d:"Notice to the employer for an offence committed under the provisions of the Code for the first time for composition of offences"}
];
